...
# Code from https://github.com/ash2shukla/streamlit-heroku/
class _SessionState:
...
# Dictionary for name space separation
CB_CONFIG_DEFAULTS: Dict[str, Any] = {
    "example_value": 0
}
    ...
    def inner(func):
        def wrapper(*args, **kwargs):
            ...
            if state.client_config is None:
                state.client_config = deepcopy(CB_CONFIG_DEFAULTS)
